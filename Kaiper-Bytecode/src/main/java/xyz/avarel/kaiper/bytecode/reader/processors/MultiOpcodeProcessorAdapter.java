...
public abstract class MultiOpcodeProcessorAdapter implements OpcodeProcessor, KOpcodeProcessor, PatternOpcodeProcessor {
    @Override
    public ReadResult process(OpcodeReader reader, Opcode opcode, KDataInput in) {
        ...
        } else if (opcode instanceof PatternOpcodes) {
